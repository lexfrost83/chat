...
define('AJAX_CHAT_ADMIN',		100);
define('AJAX_CHAT_MODERATOR',	90);
define('AJAX_CHAT_SUPPORT',		70);
define('AJAX_CHAT_PARTNER',	    20);
define('AJAX_CHAT_USER',		11);
...
// Database name:
$config['dbConnection']['name'] = 'chat66';
// Database type:
...
$config['messageTextMaxLength'] = 1000;
